  ...
  return (
    <div className="min-h-screen bg-paper">
      <header className="bg-navy px-6 py-4 flex items-center">
        <button onClick={() => router.back()} className="text-paper/70 hover:text-paper text-sm">
          ← Geri dön
        </button>
      </header>

      <main className="max-w-md mx-auto px-6 py-10">
        <h1 className="text-xl font-medium text-navy mb-1">Profilim</h1>
        <p className="text-sm text-muted mb-1">{email}</p>
        <p className="text-xs text-muted mb-6">
          Bu bilgilerin tamamı opsiyoneldir. Deneyimini kişiselleştirmek ve genel (kimliksiz) istatistikler için kullanılır, üçüncü taraflarla paylaşılmaz. İstediğin an güncelleyebilir veya boş bırakabilirsin.
        </p>
